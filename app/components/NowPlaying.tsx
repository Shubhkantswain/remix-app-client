...
const NowPlaying: React.FC<NowPlayingProps> = ({ showDetails, setShowDetails }) => {
  ...
  return (
    <div
      className={`fixed inset-0 bg-black overflow-y-auto transition-transform duration-400 ease-in-out z-50 md:hidden ${
        showDetails ? 'translate-y-0' : 'translate-y-full'
      }`}
    >
      {/* Enhanced Neutral Animated Gradient Background */}
      <div 
      ...
      <div className="relative z-10 max-w-3xl mx-auto min-h-full">
        {/* Header */}
        <div className="p-4 flex items-center justify-between backdrop-blur-sm bg-black/30">
          <button
        ...
        <div className="px-8 pt-8">
          <div 
            className={`aspect-square w-full max-w-md mx-auto bg-zinc-800 rounded-lg mb-8 transition-all duration-700 ease-in-out ${
        ...
        <div className="px-8 mt-8">
          <div className="h-1 bg-zinc-800/50 backdrop-blur-sm rounded-full">
            <div className="h-full w-1/3 bg-white/90 rounded-full"></div>
          </div>
        ...
        <div className="px-8 py-12">
          ...
          <div className="flex items-center justify-center space-x-8 mb-12">
            ...
            <button 
              className="w-16 h-16 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center text-black hover:bg-white/80 transition-all"
